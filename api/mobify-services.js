...
(function (root, factory) {
    if (true) {
        var mobifyjs_resizeImages = function (mobifyjs_utils) {
                return factory();
            }(mobifyjs_utils);
    } else if (typeof exports === 'object') {
        module.exports = factory(mobifyjs_utils_utilsjs);
    } else {
...
(function (root, factory) {
    if (true) {
        var mobifyjs_jazzcat = function (mobifyjs_utils) {
                return factory();
            }(mobifyjs_utils);
    } else if (typeof exports === 'object') {
        var Utils = mobifyjs_utils_utilsjs;
...
(function (Utils, ResizeImages, Jazzcat) {
    ...
    Jazzcat.defaults.projectName = Mobify && Mobify.config && Mobify.config.projectName || '';
...
}(mobifyjs_utils, mobifyjs_resizeImages, mobifyjs_jazzcat));
