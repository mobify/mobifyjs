...
var mobifyjs_patchAnchorLinks = function (Utils) {
        var exports = {};
        ...
        var _patchAnchorLinks = function (doc) {
            ...
            var _handler = function (e) {
                ...
                var defaultPrevented = typeof e.defaultPrevented !== 'undefined' ? e.defaultPrevented : e.getPreventDefault && e.getPreventDefault();
                if (!defaultPrevented) {
                    e.preventDefault();
...
var mobifyjs_capture = function (Utils, patchAnchorLinks) {
        ...
        return Capture;
    }(mobifyjs_utils, mobifyjs_patchAnchorLinks);
/**
