// This file is uploaded manually to //cdn.mobify.com/livereload.js
...
__reloader.Reloader = Reloader = (function() {
  ...
  Reloader.prototype.reload = function(path, options) {
    ...
    if (window.Mobify && window.Mobify.data2) {
      if (path.match(/\.(k|js|tmpl)$/i)) {
        var clone = document.createElement('script');
        clone.src = this.generateCacheBustUrl(Mobify.config.configFile);
