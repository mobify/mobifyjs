...
if ( document.querySelectorAll ) {
	(function(){
		...
		Sizzle = function( query, context, extra, seed ) {
			...
			// console.log(query); //, context, extra, seed);
			//debugger;
...
//				if (window.startDebug) Mobify.timing.addPoint(elem.slice(0, 50).replace(/\s/g, ' '));
				// Fix "XHTML"-style tags in all browsers
				elem = elem.replace(rxhtmlTag, "<$1></$2>");
				
//				if (window.startDebug) Mobify.timing.addPoint('after');
