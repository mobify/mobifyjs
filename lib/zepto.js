(function(undefined){
  if (String.prototype.trim === undefined) // fix for iOS 3.2
    ...
    // WHY MUNKEY PATCH THIS RANDOM-NESS
...
var Zepto = (function() {  
  ...
  // jQuery doesn't copy undefined values - should we do the same?
  $.extend = function(target){ 
    slice.call(arguments, 1).forEach(function(source) {
      // TODO: check source for being null/undefined

      // TODO: Check source[key] for being undefined ( null ok )
  ...
  $.fn = {
    ...
    filter: function(selector){
      if (isF(selector)) {
        ...
        this.each(function(i, el) {
          if (selector(i, el)) results.push(el);
        })
    ...
    offset: function(){
      ...
      // iOS 3.1.3 doesn't support this shaz.
      if (el.getBoundingClientRect) {
        var obj = el.getBoundingClientRect();
        return {
          left: obj.left + bodyLeft,
          top: obj.top + bodyTop,
          width: obj.width,
          height: obj.height
        };
      ...
      // TODO: Need add comptability for clients without getBoundingClientRect      
      return { 
        left: el.offsetLeft + bodyLeft, 
        top: el.offsetTop + bodyTop,
  ...
  // No conflict jacked from jQuery.
...
(function($){
  ...
  function add(element, events, fn, selector, delegate){
    ...
    events.split(/\s/).forEach(function(event){
      ...
      // JB : https://github.com/mstffn/zepto/commit/85fbb7cda84dfcb28d84dca9aa6e6af9cffda193
  ...
  // MUNKEY PATCHES!
  // Normalize like jQuery! - tolerate other races
  $.trim = function(str) {
    return str.trim();
  }
...
//RR: Added to give Zepto prerequisites for isPlainObject code.
(function(jQuery) {
    var class2type = {}, $ = jQuery, hasOwn = Object.prototype.hasOwnProperty;
    ...
    $.sub = function() {
        var zeptoSub = function(selector, context) {
            return zeptoSub.fn.init(selector, context);
        }
        $.extend( true, zeptoSub, this );

        zeptoSub.superclass = this;
        zeptoSub.fn = zeptoSub.prototype = $();
        zeptoSub.fn.constructor = zeptoSub;
        zeptoSub.prototype = $;
        zeptoSub.fn.init = $;
        return zeptoSub;
    };
